...
st.markdown(f"""
<div style="background:linear-gradient(135deg,#0d1a33 0%,#1a2744 100%);border:1px solid #2d3a5c;border-bottom:3px solid #c8a96e;border-radius:10px;padding:32px 52px;margin-bottom:32px;display:flex;align-items:center;justify-content:space-between;">
  <div style="display:flex;align-items:center;gap:28px;">
    <img src="data:image/png;base64,{LOGO_B64}" style="height:72px;width:auto;filter:brightness(0) invert(1);" />
    <div style="width:1px;height:72px;background:rgba(200,169,110,0.5);"></div>
    <div style="font-size:13px;color:#8090a8;letter-spacing:1.5px;text-transform:uppercase;line-height:2.0;">Investments that keep<br>the world moving</div>
  </div>
  <div style="text-align:right;">
    <div style="font-size:13px;color:#c8a96e;letter-spacing:2.5px;text-transform:uppercase;font-weight:600;">MIT Capstone 2026</div>
    <div style="font-size:15px;color:#f0f4f8;font-weight:700;margin-top:4px;">Armington Trade Model</div>
  </div>
</div>
""", unsafe_allow_html=True)
